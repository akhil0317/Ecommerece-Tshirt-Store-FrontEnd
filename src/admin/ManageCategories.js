...
import {getCategories,deleteCategorie} from "./helper/adminapicall"
 ...
 const  ManageCategories = () => {
   ...
   const  deleteThisCategorie = (categoryId) =>{
                
    deleteCategorie(categoryId,user._id,token)
    .then(data=>{
        if(data.error)
        {
                console.log(data.error)
